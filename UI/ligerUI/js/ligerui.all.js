...
(function ($)
{
    ...
    $.ligerui.win = {
        ...
        mask: function (win)
        {
            ...
            if (!this.windowMask)
            {
                this.windowMask = $("<div class='l-window-mask' style='display: block;z-index:9000;'>" +
                		"<iframe style='display:none;_display:block;z-index:-1;filter:mask();' frameborder=0 width=100% height=100%></iframe></div>").appendTo('body');
...
(function ($)
{
    ...
    $.ligerui.controls.Accordion.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            {
                var header = $('<div class="l-accordion-header"><div class="l-accordion-icon"></div><div class="l-accordion-toggle"></div><div class="l-accordion-header-inner"></div></div>');
                if (i == selectedIndex){
                ...
                if ($(box).attr("icon"))
                {
                    $(".l-accordion-icon", header).html("<img height=30 weight=30 src="+$(box).attr("icon")+" />");
                }
            ...
            $("div > a", $("#accordion1")).click(function() {
            	$("div > a", $("#accordion1")).each(function(index){
            		//$(this).css("font-weight","normal");
            		if($(this).hasClass("l-accordion-a-selected")){
            			$(this).removeClass("l-accordion-a-selected");
            		}
            	});
            	$(this).addClass("l-accordion-a-selected");	
            });
...
(function ($)
{
    ...
    l.controls.Dialog.ligerExtend(l.core.Win, {
        ...
        {	
            ...
            $(".l-window-mask").css("z-index",zindex);
